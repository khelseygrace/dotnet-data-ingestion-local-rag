...
2. **Find the latest release**
   ...
   On the releases page, look for the most recent build. It will usually have a version number and a date. Under "Assets," you will find a `.zip` or `.exe` file.

3. **Download the executable or zip file**

   - If you see an `.exe` file, download and run it.
   - If you see a `.zip` archive, download it then extract the folder to a preferred location on your PC.

4. **Run the application**

   - If you downloaded an installer (`.exe`), double-click it and follow the steps to install.
   - If you downloaded a zipped folder, open it and double-click the main `.exe` file inside.
...
6. **Load your markdown files**

   Use the app’s interface to add the folder or files you want to search through. The app will scan your documents and prepare them for search.
...
Once installed and running, the app’s main features include:
...
- Download the `.exe` installer or `.zip` archive for Windows.
...
You can find extra details and documentation within the app’s Help menu or at the GitHub repository’s wiki and issues sections.
...
Issues or questions about installing or using the app can be reported on the repository’s Issues tab on GitHub. Provide steps to reproduce any problems when possible.